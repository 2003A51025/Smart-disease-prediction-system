...
#%matplotlib inline
#import dataset
heart_df = pd.read_csv('D:\Videos\Captures\Desktop\docs\D15_Smart_Disease_Predictor\D15_Smart_Disease_Predictor\Medibuddy-Smart-Disease-Predictor-main - Copy\data\heart.csv')
heart_df.head(10)
...
import pickle
model = rfc
pickle.dump(model, open(r"C:\Users\ganes\OneDrive\Desktop\Medibuddy-Smart-Disease-Predictor-main\models\heart.pkl",'wb'))
